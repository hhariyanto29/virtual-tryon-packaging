...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Xi,depthTest:!1,depthWrite:!1})}function Hh(){return new Ki({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ru(),fragmentShader:`
		...
		`,blending:Xi,depthTest:!1,depthWrite:!1})}function Gh(){return new Ki({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ru(),fragmentShader:`
